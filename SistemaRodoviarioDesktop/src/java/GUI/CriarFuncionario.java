...
public class CriarFuncionario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try { 
          ...
          funcionario = new Funcionario(nomeText.getText(), senhaText.getText(), usuText.getText());         
          bean.salvar(funcionario);
          JOptionPane.showMessageDialog(null, "Usuário criado: "+nomeText.getText());
